...
public class Game extends Canvas implements Runnable {
	...
	private int maxFrames = 10; //de quantos em quantos frames o personagem será animado
	...
	public void render() { //Método para rederizar tudo
		...
		//g2.rotate(Math.toRadians(90), 90+8, 90+8); //Rotaciona 90 graus na posição 98,
		//pois ele se encontra na posição 90 e 8 é a metade de 16, ou seja, o meio do boneco
		g2.drawImage(player[currAnimation], 90, 90, null);
		
		/***/
		g.dispose(); //Método de otimização para limpar dados não utilizados mais na imagem
